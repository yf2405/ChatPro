...
var stylesheet = /*#__PURE__*/flairup.createSheet('epr');
var hidden = {
  display: 'none',
  opacity: '0',
  pointerEvents: 'none',
...
function ClickableEmojiButton(_ref) {
  ...
  return React.createElement(Button, {
    className: flairup.cx(styles$1.emoji, hidden && commonStyles.hidden, hiddenOnSearch && commonInteractionStyles.hiddenOnSearch, (_cx = {}, _cx[ClassNames.visible] = !hidden && !hiddenOnSearch, _cx), !!(hasVariations && showVariations) && styles$1.hasVariations),
...
function EmojiCategory(_ref) {
  ...
  return React.createElement("li", {
    className: flairup.cx(styles$4.category, hidden && commonStyles.hidden, hiddenOnSearch && commonInteractionStyles.hiddenOnSearch),
    "data-name": category,
    "aria-label": categoryName
  }, React.createElement("h2", {
    className: flairup.cx(styles$4.label)
  }, categoryName), React.createElement("div", {
    className: flairup.cx(styles$4.categoryContent)
  }, children));
}
...
function EmojiList() {
  ...
  return React.createElement("ul", {
    className: flairup.cx(styles$5.emojiList)
...
function EmojiVariationPicker() {
  ...
  return React.createElement("div", {
    ...
    className: flairup.cx(styles$6.variationPicker, getMenuDirection() === Direction.Down && styles$6.pointingUp, visible && styles$6.visible),
    style: {
      top: top
    }
    ...
    className: flairup.cx(styles$6.pointer),
    style: pointerStyle
  }));
}
...
function Body() {
  ...
  useOnMouseMove();
  return React.createElement("div", {
    className: flairup.cx(styles$7.body),
    ref: BodyRef
...
function Flex(_ref) {
  ...
  return React.createElement("div", {
    ...
    className: flairup.cx(styles$8.flex, className, styles$8[direction])
  }, children);
}
var styles$8 = /*#__PURE__*/stylesheet.create((_stylesheet$create = {
  flex: {
    display: 'flex'
  }
...
function SkinTonePicker(_ref) {
  ...
  return React.createElement(Relative, {
    className: flairup.cx(styles$9.skinTones, vertical && styles$9.vertical, isOpen && styles$9.open),
    style: vertical ? {
    ...
    className: flairup.cx(styles$9.select),
    ...
    return React.createElement(Button, {
      ...
      className: flairup.cx("epr-tone-" + skinToneVariation, styles$9.tone, !isOpen && styles$9.closedTone, active && styles$9.active),
      tabIndex: isOpen ? 0 : -1,
      "aria-pressed": active,
...
function Preview() {
  ...
  return React.createElement(Flex, {
    className: flairup.cx(styles$a.preview)
...
function PreviewBody() {
  ...
  function PreviewContent() {
    ...
    return React.createElement(React.Fragment, null, React.createElement("div", null, show ? React.createElement(ViewOnlyEmoji, {
      ...
      size: 45,
      getEmojiUrl: getEmojiUrl,
      className: flairup.cx(styles$a.emoji)
      ...
      className: flairup.cx(styles$a.label)
...
function CategoryNavigation() {
  ...
  return React.createElement("div", {
    className: flairup.cx(styles$b.nav),
    role: "tablist",
    ...
    return React.createElement(Button, {
      ...
      className: flairup.cx(styles$b.catBtn, commonInteractionStyles.categoryBtn, "epr-icn-" + category, (_cx = {}, _cx[ClassNames.active] = isActiveCategory, _cx)),
      key: category,
      onClick: function onClick() {
...
function SearchContainer() {
  ...
  return React.createElement(Flex, {
    className: flairup.cx(styles$c.overlay)
...
function Search() {
  ...
  return React.createElement(Relative, {
    className: flairup.cx(styles$c.searchContainer)
    ...
    className: flairup.cx(styles$c.search),
    type: "text",
    ...
    role: "status",
    className: flairup.cx('epr-status-search-results', styles$c.visuallyHidden),
    "aria-live": "polite",
    id: "epr-search-id",
    "aria-atomic": "true"
  }, statusSearchResults) : null, React.createElement("div", {
    className: flairup.cx(styles$c.icnSearch)
  }), React.createElement(Button, {
    className: flairup.cx(styles$c.btnClearSearch, commonInteractionStyles.visibleOnSearchOnly),
    onClick: clearSearch,
    "aria-label": "Clear",
    title: "Clear"
  }, React.createElement("div", {
    className: flairup.cx(styles$c.icnClearnSearch)
  })));
}
...
function PickerMain(_ref) {
  var children = _ref.children;
  return React.createElement(PickerContextProvider, null, React.createElement(PickerStyleTag, null), React.createElement(PickerRootElement, null, children));
}
function PickerRootElement(_ref2) {
  ...
  return React.createElement("aside", {
    className: flairup.cx(styles$d.main, styles$d.baseVariables, theme === exports.Theme.DARK && styles$d.darkTheme, theme === exports.Theme.AUTO && styles$d.autoThemeDark, (_cx = {}, _cx[ClassNames.searchActive] = searchModeActive, _cx), className),
    ref: PickerMainRef,
    style: style
  }, children);
}
