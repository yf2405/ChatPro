import React__default, { useState, useEffect, createElement, useRef, createContext, createRef, useContext, useMemo, useCallback, Fragment, memo, Component } from 'react';
...
var stylesheet = /*#__PURE__*/createSheet('epr');
var hidden = {
  display: 'none',
  opacity: '0',
  pointerEvents: 'none',
...
function ClickableEmojiButton(_ref) {
  ...
  return createElement(Button, {
    className: cx(styles$1.emoji, hidden && commonStyles.hidden, hiddenOnSearch && commonInteractionStyles.hiddenOnSearch, (_cx = {}, _cx[ClassNames.visible] = !hidden && !hiddenOnSearch, _cx), !!(hasVariations && showVariations) && styles$1.hasVariations),
...
function EmojiCategory(_ref) {
  ...
  return createElement("li", {
    className: cx(styles$4.category, hidden && commonStyles.hidden, hiddenOnSearch && commonInteractionStyles.hiddenOnSearch),
    "data-name": category,
    "aria-label": categoryName
  }, createElement("h2", {
    className: cx(styles$4.label)
  }, categoryName), createElement("div", {
    className: cx(styles$4.categoryContent)
  }, children));
}
...
function EmojiList() {
  ...
  return createElement("ul", {
    className: cx(styles$5.emojiList)
...
function EmojiVariationPicker() {
  ...
  return createElement("div", {
    ...
    className: cx(styles$6.variationPicker, getMenuDirection() === Direction.Down && styles$6.pointingUp, visible && styles$6.visible),
    style: {
      top: top
    }
...
function Flex(_ref) {
  ...
  return createElement("div", {
    ...
    className: cx(styles$8.flex, className, styles$8[direction])
  }, children);
}
...
function SkinTonePicker(_ref) {
  ...
  return createElement(Relative, {
    className: cx(styles$9.skinTones, vertical && styles$9.vertical, isOpen && styles$9.open),
    style: vertical ? {
    ...
    return createElement(Button, {
      ...
      className: cx("epr-tone-" + skinToneVariation, styles$9.tone, !isOpen && styles$9.closedTone, active && styles$9.active),
      tabIndex: isOpen ? 0 : -1,
      "aria-pressed": active,
...
function CategoryNavigation() {
  ...
  return createElement("div", {
    ...
    return createElement(Button, {
      ...
      className: cx(styles$b.catBtn, commonInteractionStyles.categoryBtn, "epr-icn-" + category, (_cx = {}, _cx[ClassNames.active] = isActiveCategory, _cx)),
      key: category,
      onClick: function onClick() {
...
function Search() {
  ...
  return createElement(Relative, {
    className: cx(styles$c.searchContainer)
    ...
    role: "status",
    className: cx('epr-status-search-results', styles$c.visuallyHidden),
    "aria-live": "polite",
    id: "epr-search-id",
    "aria-atomic": "true"
  }, statusSearchResults) : null, createElement("div", {
    className: cx(styles$c.icnSearch)
  }), createElement(Button, {
    className: cx(styles$c.btnClearSearch, commonInteractionStyles.visibleOnSearchOnly),
    onClick: clearSearch,
    "aria-label": "Clear",
    title: "Clear"
  }, createElement("div", {
    className: cx(styles$c.icnClearnSearch)
  })));
}
...
function PickerMain(_ref) {
  var children = _ref.children;
  return createElement(PickerContextProvider, null, createElement(PickerStyleTag, null), createElement(PickerRootElement, null, children));
}
function PickerRootElement(_ref2) {
  ...
  return createElement("aside", {
    className: cx(styles$d.main, styles$d.baseVariables, theme === Theme.DARK && styles$d.darkTheme, theme === Theme.AUTO && styles$d.autoThemeDark, (_cx = {}, _cx[ClassNames.searchActive] = searchModeActive, _cx), className),
    ref: PickerMainRef,
    style: style
  }, children);
}
