...
type Styles = Partial<StyleObject & FlairUpProperties & Chunks & PostConditionStyles>;
type PostConditionStyles = {
    [k: PostCondition]: StyleObject | FlairUpProperties | Chunks | PostConditionStyles;
};
...
type S<K extends string> = Exclude<K, PreConditionKey | '--' | '.' | keyof CSSStyleDeclaration | Pseudo | MediaQuery>;
